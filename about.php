...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        <h3>Tentang Kami</h3>
        <br>
        <p>MyPoll adalah website atau situs penyedia polling, atau jajak pendapat dan survey sederhana bagi semua orang. 
          Hasil polling jangan digunakan sebagai polling yang representatif.
        </p>
    </div>
</div>
 <!-- end jumbotron -->
