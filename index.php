...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		<!-- Navbar -->
		<nav class="main-header navbar navbar-expand navbar-green navbar-light" style="background-color: #FFE4C4;">
			<!-- Left navbar links -->
			<ul class="navbar-nav">
				<li class="nav-item">
				...
				<nav class="mt-2">
					...
					//Level Admin
						...
						?>
							...
							<!-- <li class="nav-item">
								<a href="?page=PsSQAdT=-1" class="nav-link">
					...
					if (isset($_GET['page'])) {
						...
						//Menu Bilik Suara
							...
							case 'view':
								...
								break;
						//end Menu Bilik Suara

						//Menu Kotak Suara
							case 'data-kotak':
								include "admin/kotak/data_kotak.php";
								break;
						//end Menu Kotak Suara
		...
		<footer class="main-footer">
			...
			Copyright &copy; 2022
			<a target="_blank" href="https://www.instagram.com/gitaairlangga/">
				<strong>MyPoll</strong>
			</a>
